...
using ScheduledTask.ScheduledTasks;
using System;
using System.Net;
using System.Web;
...
namespace InsuranceLetters
{
    ...
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            DataAnnotationsModelValidatorProvider.RegisterAdapter(typeof(ValidCPF), typeof(ValidCPFValidator));
            DataAnnotationsModelValidatorProvider.RegisterAdapter(typeof(ValidCountry), typeof(ValidCountryValidator));
