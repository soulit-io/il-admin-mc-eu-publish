var findTickets = function (home, slug, application, properties, callbackOk=null, callbackFail) {
	$.ajax({
...
var findCtaTransacction = function (homeUrl, slug, callbackOk = null, callbackFail) {
    $.ajax({
        url: homeUrl + "/CTA/GetChildContext?slug=" + slug,
        type: "GET",
        success: function (data, textStatus, jqXHR) {
            callbackOk(data);
        },
